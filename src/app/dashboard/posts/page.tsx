...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-xl mx-auto p-8 bg-white rounded-3xl shadow-2xl mt-10 border border-gray-100">
      <h1 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-green-500 text-center mb-8">PostJet Dashboard</h1>
      ...
      <div className="grid grid-cols-2 gap-4 mt-10">
        <button onClick={() => handlePost("whatsapp")} className="bg-[#25D366] text-white p-5 rounded-2xl font-black hover:shadow-green-200 shadow-xl transition-all active:scale-95">WhatsApp</button>
        <button onClick={() => handlePost("telegram")} className="bg-[#0088cc] text-white p-5 rounded-2xl font-black hover:shadow-blue-200 shadow-xl transition-all active:scale-95">Telegram</button>
        <button onClick={() => handlePost("instagram")} className="bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] text-white p-5 rounded-2xl font-black shadow-xl transition-all active:scale-95">Instagram</button>
        <button onClick={() => handlePost("youtube")} className="bg-[#FF0000] text-white p-5 rounded-2xl font-black shadow-xl transition-all active:scale-95">YouTube</button>
      </div>
